...
void init_graph() {
  ...
  for ( int i=0; i<121; i++ ) { 
    text( ( i), 30+20*i, 750 );
    line(30+20*i,40,30+20*i,760);
    line(30,700-12*i,1260,700-12*i);
    line(30,700-60*i,1260,700-60*i);    //line(30,640-60*i,1260,640-60*i);     
   // text ("|", 30+30*i, 760);
  }
  stroke(0,250,0);
...
void setup()
{
 ...
 size(1260,788);   //OLDsize(1260,760);
 init_graph();
 xPos=dx;
 xPos2=dx2;
 xPos3=dx3;
 ...
 myPort=new Serial(this,"COM4",9600);  //COM23DEFAULT
}
void draw()
